  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6">
      <div className="card">
        ...
        <a href="/#signin" className="btn-primary">Claim now</a>
      </div>

      <div className="card">
        <div className="text-sm muted mb-2">Featured Tournament</div>
        <div className="text-xl font-semibold mb-2">Neon Royale Cup</div>
        <p className="text-sm muted mb-4">Compete with thousands and climb the leaderboard.</p>
      ...
      <div className="card md:col-span-2">
        <div className="flex items-center justify-between mb-3">
          ...
          <a href="/#explore" className="text-sm underline">See all</a>
        </div>
